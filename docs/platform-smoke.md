...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Linux GUI | `dudka-linux-amd64.deb` / `.tar.gz` | ✅ GitHub Actions | ✅ DEB artifact | ⚠️ CI launch smoke | ⚠️ protocol tests | 2026-07-28 / v0.4.0 | agent |
...
| Windows GUI | `dudka-windows-amd64-setup.exe` / update ZIP | ✅ GitHub Actions | ✅ installer artifact | ⚠️ CI widget/protocol | ⚠️ protocol tests | 2026-07-28 / v0.4.0 | agent |
