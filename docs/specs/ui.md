...
тот же Flutter GUI. Windows публикуется одним переносимым ZIP без установщика:
...
записи удаления или системную установку. Linux публикуется как устанавливаемый
GUI-пакет; TUI остаётся отдельным дополнительным инструментом.
