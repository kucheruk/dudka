...
Техническую ошибку Linux TUI можно скопировать одной клавишей без установки
системных пакетов.

Проверка:

- пока ошибки нет, F5 ничего не делает и не занимает место в подсказках;
- после ошибки видна подсказка `F5 · КОПИРОВАТЬ ОШИБКУ`;
- F5 передаёт полный технический текст в системный буфер терминала через OSC 52;
...
- evidence: `internal/tui/clipboard_test.go`,
  `internal/tui/screen_test.go` *(P159)*.
