...
- интеграционный тест: блокировщик/прокси фиксирует ноль WAN-попыток при типичном сценарии чата;
- негатив: подсовывание публичного IP в конфиг не приводит к connect;
- evidence: тест + лог.
