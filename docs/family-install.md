...
Скачайте и запустите `dudka-windows-amd64-setup.exe`. Установщик создаёт один
ярлык **ДУДКА** и запускает графическое приложение без терминала. Никакие
вторые EXE вручную запускать не нужно.
