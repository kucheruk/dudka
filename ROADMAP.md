...
- [x] P149 Windows получил единый GUI-пакет без терминального окна и
  ...
  (`DUD-UI-180`)
- [x] P150 Linux получает полноценную Flutter GUI-сборку и устанавливаемый
  пакет; TUI остаётся дополнительным (`DUD-UI-180`)
...
- [x] P155 Linux GUI устанавливается также через проверяемый shell-однострочник;
  DEB и архив сохранены, пакет проходит установочный smoke на Ubuntu
  (`DUD-UI-183`)
