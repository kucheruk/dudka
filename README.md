...
Flutter↔engine (P060–P062): subprocess + HTTP loopback, **macOS-first** shell в `apps/dudka` — first-run ник (RU) → чат; bind ADR [`docs/design/flutter-bind.md`](docs/design/flutter-bind.md); `./scripts/flutter_bind_test.sh`, `./scripts/flutter_skeleton_test.sh`, `./scripts/flutter_firstrun_test.sh`, `./scripts/run_flutter_spike.sh`.
