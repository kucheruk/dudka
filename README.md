...
Flutter↔engine (P060–P070): subprocess + HTTP loopback, **macOS-first** shell в `apps/dudka` — DESIGN.md charcoal UI + adaptive dual-pane/peer strip + чат/файлы/превью; bind ADR [`docs/design/flutter-bind.md`](docs/design/flutter-bind.md); `./scripts/flutter_*_test.sh`, `./scripts/run_flutter_spike.sh`.
