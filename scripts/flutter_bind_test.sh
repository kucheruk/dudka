...
[[ -f apps/dudka/lib/engine/client.dart ]] || fail "apps/dudka/lib/engine/client.dart missing"
...
grep -q 'fetchMe' apps/dudka/lib/engine/client.dart || fail "EngineClient.fetchMe missing"
grep -q 'MeScreen' apps/dudka/lib/screens/me_screen.dart || fail "hello /me screen missing"
grep -q 'GET /me' apps/dudka/lib/screens/me_screen.dart || fail "screen must label GET /me"
